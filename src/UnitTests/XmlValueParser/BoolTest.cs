...
namespace Appson.Composer.UnitTests.XmlValueParser
{
	...
	public class BoolTest
	{
		...
		{
			_context.ProcessCompositionXmlFromResource("Compositional.Composer.UnitTests.XmlValueParser.Xmls.ABool.xml");
		...
		{
			_context.ProcessCompositionXmlFromResource("Compositional.Composer.UnitTests.XmlValueParser.Xmls.EBool.xml");
