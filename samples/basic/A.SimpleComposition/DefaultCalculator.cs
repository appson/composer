...
namespace Compositional.Composer.Samples.Basic
{
	...
	public class DefaultCalculator : ICalculator
	{
		...
		{
            // This is called when Composer instantiates the component.
		...
		public int Add(int a, int b)
		{
            ...
            // User IAdder provided contract to fulfill the "Add"
		...
		public int Multiply(int a, int b)
		{
            ...
            // User IMultiplier provided contract to fulfill the "Multiply"
            // request, from ICalculator contract.
		...
		public int Divide(int a, int b)
		{
            ...
            // User IDivider provided contract to fulfill the "Divide"
            // request, from ICalculator contract.
		...
		public int Remainder(int a, int b)
		{
            ...
            // User IDivider provided contract to fulfill the "Remainder"
            // request, from ICalculator contract.
